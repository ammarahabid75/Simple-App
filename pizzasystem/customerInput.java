...
public class customerInput  {
    ...
    customerInput()
    {
        ...
        label5 = new JLabel();
        label5.setText("Telefoon nummer ");
    ...
    public void actionPerformed(ActionEvent ac) {
        ...
        if(ac.getSource()==button1)
        {
            ...
            String sql = "INSERT INTO customer (customerid , customername, customeraddress , customerphoneno ) VALUES (NULL, ?, ?, ?);";
