...
public class employeeInput {
    ...
    public void actionPerformed(ActionEvent ac) {
        ...
        if(ac.getSource()==button1)
        {
            ...
            String sql = "INSERT INTO product (employeeid , employeename, employeefunction ) VALUES (NULL, ?, ?);";
