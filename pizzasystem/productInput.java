...
public class productInput {
    ...
    public void actionPerformed(ActionEvent ac) {
        ...
        if(ac.getSource()==button1)
        {
            ...
            String sql = "INSERT INTO product (productid , productname, productprice , productingredients ) VALUES (NULL, ?, ?, ?);";
